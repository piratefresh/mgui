import MostPopularArticles, {
  IMostPopularArticles,
} from "./MostPopularArticles";

export default {
  title: "Components/Most Popular Articles",
  component: MostPopularArticles,
};

export const Default = (args: IMostPopularArticles) => (
  <MostPopularArticles {...args}></MostPopularArticles>
);
  ...
  articles: [
    {
      ...
      href: "/",
      imageUrl:
        "https://res.cloudinary.com/film-it/image/upload/v1633130476/original2.webp",
