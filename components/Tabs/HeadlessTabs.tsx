...
import {
  ...
  Features,
  PropsForFeatures,
} from "../../node_modules/@headlessui/react/dist/utils/render";
import { useId } from "../../node_modules/@headlessui/react/dist/hooks/use-id";
import { match } from "../../node_modules/@headlessui/react/dist/utils/match";
import { Keys } from "../../node_modules/@headlessui/react/dist/components/keyboard";
import {
  focusIn,
  Focus,
} from "../../node_modules/@headlessui/react/dist/utils/focus-management";
import { useIsoMorphicEffect } from "../../node_modules/@headlessui/react/dist/hooks/use-iso-morphic-effect";
import { useSyncRefs } from "../../node_modules/@headlessui/react/dist/hooks/use-sync-refs";
import { useResolveButtonType } from "../../node_modules/@headlessui/react/dist/hooks/use-resolve-button-type";
...
function List<TTag extends ElementType = typeof DEFAULT_LIST_TAG>(
  ...
  let [{ selectedIndex, orientation }] = useTabsContext(
